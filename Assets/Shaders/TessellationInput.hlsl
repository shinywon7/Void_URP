...
UNITY_DOTS_INSTANCING_START(MaterialPropertyMetadata)
    ...
    UNITY_DOTS_INSTANCED_PROP(float4, _WaveA)
    UNITY_DOTS_INSTANCED_PROP(float4, _WaveB)
    UNITY_DOTS_INSTANCED_PROP(float4, _WaveC)
...
#define _TessellationEdgeLength UNITY_ACCESS_DOTS_INSTANCED_PROP_FROM_MACRO(float  , Metadata_TessellationEdgeLength)
#define _WaveA                  UNITY_ACCESS_DOTS_INSTANCED_PROP_FROM_MACRO(float4 , Metadata_WaveA)
#define _WaveB                  UNITY_ACCESS_DOTS_INSTANCED_PROP_FROM_MACRO(float4 , Metadata_WaveB)
#define _WaveC                  UNITY_ACCESS_DOTS_INSTANCED_PROP_FROM_MACRO(float4 , Metadata_WaveC)
#define _Offset                 UNITY_ACCESS_DOTS_INSTANCED_PROP_FROM_MACRO(float4 , Metadata_Offset)
...
inline void InitializeStandardLitSurfaceData(float2 uv, out SurfaceData outSurfaceData, float3 positionWS)
{
