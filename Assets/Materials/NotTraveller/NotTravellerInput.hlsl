...
TEXTURE2D_X_FLOAT(_CopyDepthTexture); SAMPLER(sampler_CopyDepthTexture);
...
inline void InitializeStandardLitSurfaceData(float2 uv, out SurfaceData outSurfaceData, float cutOff)
{
    half4 albedoAlpha = SampleAlbedoAlpha(uv, TEXTURE2D_ARGS(_BaseMap, sampler_BaseMap));
    outSurfaceData.alpha = Alpha(albedoAlpha.a, _BaseColor, cutOff);
