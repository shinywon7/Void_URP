...
UNITY_DOTS_INSTANCING_START(MaterialPropertyMetadata)
    ...
    UNITY_DOTS_INSTANCED_PROP(float4, _FrontLightColor)
    UNITY_DOTS_INSTANCED_PROP(float4, _BackLightColor)
    ...
    UNITY_DOTS_INSTANCED_PROP(float , _PowRate)
UNITY_DOTS_INSTANCING_END(MaterialPropertyMetadata)


#define _BaseColor              UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float4 , _BaseColor)
#define _FrontLightColor        UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float4 , _FrontLightColor)
#define _BackLightColor         UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float4 , _BackLightColor)
...
#define _PowRate                UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float  , _PowRate)
#endif
...
TEXTURE2D(_FrontHeightTexture); SAMPLER(sampler_FrontHeightTexture);
TEXTURE2D(_BackHeightTexture);  SAMPLER(sampler_BackHeightTexture);
...
inline void InitializeStandardLitSurfaceData(float2 uv, out SurfaceData outSurfaceData, float fadeRate)
{
    ...
    outSurfaceData.smoothness = lerp(specGloss.a,0,fadeRate);
